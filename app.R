...
ui <- fluidPage(
    ...
    hr(),
    fluidRow(
        column(6, selectInput('base_benchmark', 'Baseline', benchmarks, selected = "develop_dec8ff7ba1_matvar")),
        column(6, selectInput('comp_benchmark', 'Comparison', benchmarks, selected = "a_few_varmats_0566e91116_matvar"))
    ),
    hr(),
